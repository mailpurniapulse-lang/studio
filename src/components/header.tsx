          ...
          <nav className="flex items-center space-x-6 text-sm font-medium">
            {navLinks.map((link) => (
              <Link
                ...
                href={link.href}
                className={[
                  "transition-colors font-semibold text-white px-4 py-2 rounded-lg",
                  "bg-gradient-to-r",
                  link.href.length % 2 === 0 ? "from-blue-500 to-purple-500" : "from-pink-500 to-yellow-400",
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="p-0 h-auto text-sm flex items-center gap-1 bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 border-2 border-blue-400 text-blue-900 font-semibold shadow-md focus:ring-2 focus:ring-blue-400">
                  Tools <ChevronDown id="brand" className="h-4 w-4" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="start" className="bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
                ...
                {navLinks.map((link, idx) => (
                  <Link
                    ...
                    className={[
                      "transition-colors font-semibold text-white px-4 py-2 rounded-lg",
                      "bg-gradient-to-r",
                      idx % 2 === 0 ? "from-blue-400 to-purple-400" : "from-pink-400 to-yellow-400",
