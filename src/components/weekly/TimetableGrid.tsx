...
import type { WeekSchedule } from "@/lib/weekly/types";
...
export default function TimetableGrid({ 
	...
	return (
		<div className="flex-1">
            				{/* Heading for export: centered, bold, matches screenshot */}

			<div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
				<div className="pt-6 pb-2 px-6 bg-white">
					<h2 className="text-xl font-bold text-center text-black" style={{fontFamily: 'inherit'}}>
						{selectedClass} - Weekly Timetable
					</h2>
				</div>
				{/* Controls row (not included in export) */}
				...
				<div className="p-6" id="timetable-container">
					<div className="overflow-x-auto">
								<div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
									<div className="p-6" id="export-area">
