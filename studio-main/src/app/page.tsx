...
export default function HomePage() {
  return (
    <>
      <Head>
        <meta name="description" content="Purnia Pulse is your digital gateway to the vibrant culture, businesses, and creative minds of Purnea, Bihar. Discover blogs, listings, and useful tools for the community." />
      ...
      <section className="relative w-full h-[80vh] md:h-[90vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center text-center px-4">
          <div className="text-white max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-4 drop-shadow-lg">Our Purnea</h1>
      ...
      <section className="w-full py-16 bg-background">
        <div className="container mx-auto max-w-5xl px-4 md:px-6 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-headline font-bold mb-4">About Purnia Pulse</h2>
      ...
      {/* Ad Placeholder */}
      <ClientOnly>
        <div className="container mx-auto max-w-5xl px-4 md:px-6 my-8 text-center">
      ...
      <section id="features" className="w-full py-20 md:py-24">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl font-headline font-bold text-center mb-12">What We Offer</h2>
      ...
      <section className="w-full py-20 bg-secondary/30">
        <div className="container mx-auto max-w-4xl px-4 md:px-6 text-center">
          ...
          <p className="mt-2 text-muted-foreground max-w-xl mx-auto">
            This project is built with modern technologies to provide a fast, reliable, and enjoyable experience for everyone.
          </p>
        </div>
      </section>
    </>
