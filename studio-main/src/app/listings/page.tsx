...
const categories: Category[] = [
    ...
    { value: 'Hospital', label: 'Hospital', subCategories: [
        ...
        { value: 'Child-Specialists', label: 'Child-Specialists' },
    ]},
...
export function ListingsMeta() {
  return (
    <Head>
      <meta name="viewport" content="width=device-width, initial-scale=1" />
      <meta name="description" content="Browse and review business listings in Purnea. Find local services, restaurants, hospitals, and more on PurniaPulse." />
      <link rel="canonical" href="https://purniapulse.in/listings" />
    </Head>
  );
}
